...
migrateup:
	migrate -path db/migration -database "postgresql://root:N0d9T9nqV7cJIYh0NOG6@simple-bank.cy7yo8urtjyh.ap-southeast-1.rds.amazonaws.com:5432/simple_bank" -verbose up
migratedown:
